...
if ($verified) {
    ...
    if ($_POST['receiver_email'] != 'tompav_1344902820_biz@gmail.com') {
        $errmsg .= "'receiver_email' does not match: ";
        $errmsg .= $_POST['receiver_email']."\n";
    }
    
    // 3. Make sure the amount(s) paid match
    if ($_POST['mc_gross'] != '9.00') {
    ...
    if (!empty($errmsg)) {
		...
		if ($rowcount > 0) {
			...
			if (!ssh2_exec($sshConnection, "passwd $usernamevpn -u")) {
		...
		//Send them a confirmation email with password ****************************************
		 smtpmailer("namgotme@gmail.com", 'vpnflix@gmail.com', 'VPNFlix', "$subject", "$body");
		//End Send Email ***********************************************************************
