...
<meta charset="UTF-8" />
<meta charset="UTF-8" />
<title>VPNFlix | Do I need to download a program to connect to the VPN?</title>
<!-- CSS -->
...
<div id="site-wrapper">
  ...
  <header>
    ...
    <div class="container">
      ...
      <ul class="sf-menu">
        ...
        <li><a href="pricing.php">Features and Pricing</a>
      ...
      <div id="pagename">
        <div class="inside">
          <h2>Do I need to download a program to connect to the VPN?</h2>
          <p class="breadcrumbs">You are here : <a href="index.php">Home</a> / <a href="faq.php">FAQ and How-to</a></p>
        </div>
      </div>
    </div>
    <!-- container END here -->
  ...
  <div id="content">
	...
	<h3>If you do not have the OpenVPN software, yes.  You will be prompted to download the software at your first login to the VPN.  Once you download and install it you wont have to do it again.
	</h3>
