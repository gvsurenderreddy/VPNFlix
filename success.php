...
<meta charset="UTF-8" />
<meta charset="UTF-8" />
<title>VPNFlix | Payment Successful!</title>
<!-- CSS -->
...
<div id="site-wrapper">
  ...
  <header>
    ...
    <div class="container">
      ...
      <div id="pagename">
        <div class="inside">
          <h2>Success!</h2>
          <p class="breadcrumbs">You are here : <a href="#">Home</a> / Success!</p>
        </div>
      </div>
    </div>
    <!-- container END here -->
  ...
  <div id="content">
	...
	<center>
	<h1>Success!</h1> <h4></br></br>Check your inbox for login information. If you didn't receive it then check your spam folder. If you added another month to your account then it has been added automatically.</h4><br/><br/>
