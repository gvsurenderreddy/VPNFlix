...
<meta charset="UTF-8" />
<meta charset="UTF-8" />
<title>VPNFlix | What is a VPN?</title>
<!-- CSS -->
...
<div id="site-wrapper">
  ...
  <header>
    ...
    <div class="container">
      ...
      <ul class="sf-menu">
        ...
        <li class="current_page_item"><a href="what-is-a-vpn.php">What is a VPN?</a></li>
      ...
      <div id="pagename">
        <div class="inside">
          <h2>What is a VPN?</h2>
          <p class="breadcrumbs">You are here : <a href="#">Home</a> / What is a VPN?</p>
        </div>
      </div>
    </div>
    <!-- container END here -->
  ...
  <div id="content">
	...
	Setting up a VPN is a straightforward process. It's often as simple as entering a username and sever address. The dominate smartphones can configure VPNs using PPTP and L2TP/IPsec protocols. All major operating systems can configure PPTP VPN connections. OpenVPN and L2TP/IPsec protocols require a small open source application (OpenVPN) and certificate download respectively.
