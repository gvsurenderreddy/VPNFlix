...
<div id="site-wrapper">
  ...
  <div id="content">
	...
	$row = mysql_fetch_array($result);
		$expiryunix = $row['expiry'];
		$expiry = date("F d, Y", $expiryunix);
		
	$timenow = time();
	if ($timenow > $expiryunix) {
		$status = "Disabled, Payment Needed";
	} else {
		$status = "Active";
	}
	...
	<h1><?php echo $_COOKIE['ID_my_site']; ?></h1><br/>
	<h4>Account Status: <?php if ($status == "Active") { echo "<font color='green'>"; }else { echo "<font color='red'>";  } echo $status;?></font></h4>
	<h4>Payment Due: <?php echo $expiry; ?></h4><br/>
	<h4><a href="http://vpnflix.com/choose.php"><font color="blue">Connect to VPN</font></a></h4>
	<h4><a href="makepayment.php">Add 1 Month</a></h4>
	<h4><a href="6months.php">Add 6 Months(1 month free!)</a></h4>
	<h4><a href="editacct.php">Change Password</a></h4>
	<h4><a href="logoff.php">Log Off</a></h4>
	<?php if ($_COOKIE['ID_my_site'] == "itworks") { echo "<h4><a href='admin.php'>Admin Area</a></h4>";  } ?>
