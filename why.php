...
<meta charset="UTF-8" />
<meta charset="UTF-8" />
<title>VPNFlix | Why choose VPNFlix?</title>
<!-- CSS -->
...
<div id="site-wrapper">
  ...
  <header>
    ...
    <div class="container">
      ...
      <ul class="sf-menu">
        ...
        <li class="current_page_item"><a href="why.php">Why Choose VPNFlix?</a></li>
      ...
      <div id="pagename">
        <div class="inside">
          <h2>Why Choose VPNFlix?</h2>
          <p class="breadcrumbs">You are here : <a href="index.php">Home</a> / Why Choose VPNFlix?</p>
        </div>
      </div>
    </div>
    <!-- container END here -->
  ...
  <div id="content">
    ...
    <div class="container">
        <!-- one_half START here -->
        <div class="one_half">
        <img src="images/services-icons/world.png" alt="" class="alignleft icon" /> 
        <h3>Unblock Your Internet</h3>
        <p>Browse the Internet without any restrictions.  Bypass your country's restrictions and become free.  When you connect through our VPN your computer's identity changes to a United States identity.  Be free and secure.</p>
        </div>
        <!-- one_half END here -->
        <!-- one_half START here -->
        <div class="one_half no-margin">
        <img src="images/services-icons/shield.png" alt="" class="alignleft icon" /> 
        <h3>Secure Your Data</h3>
        <p>Each time you send data through the Internet you put yourself at risk for hackers to see your data.  Protect your Internet connection from hackers who want to steal your data by using VPNFlix.  While connected to our VPN your data gets encrypted so hackers cannot see it. </p>
        </div>
        <!-- one_half END here -->
        <!-- one_half START here -->
        <div class="one_half">
        <img src="images/services-icons/support.png" alt="" class="alignleft icon" /> 
        <h3>100% Amazing Support</h3>
        <p>Client satisfaction is our priority and guarantee. We want to make sure you are happy with our service.  If you have any questions or comments please let us know by sending us an email: support@vpnflix.com</p>
        </div>
        <!-- one_half END here -->
        <!-- one_half START here -->
        <div class="one_half no-margin">
        <img src="images/services-icons/green.png" alt="" class="alignleft icon" /> 
        <h3>VPNFlix Goes Green</h3>
        <p>We only use the resources that we need.  We utilize cloud servers so we can specify exactly what resources will be used.  This way we help keep Earth green and healthy while providing the best services to you.</p>
        <p><a href="pricing.php" class="big-btn red">Buy Now for only $4/month</a></p>
		</div>
        <!-- one_half END here -->
    </div>
    <!-- container END here -->
