...
$('#custom').keyup(username_check);
});


	
function username_check(){	
var username = $('#custom').val();
if(username == "" || username.length < 1){
$('#custom').css('border', '3px #CCC solid');
$('#tick').hide();
}else{
...
if(response == 1){
	$('#custom').css('border', '3px #C33 solid');	
	$('#tick').hide();
	$('#cross').fadeIn();
	...
	$('#custom').css('border', '3px #090 solid');
	$('#cross').hide();
	$('#tick').fadeIn();
	...
	var username = $('#custom').val();
var x=document.forms["buynow"]["custom"].value;
if (x==null || x=="")
  {
...
<div id="site-wrapper">
  ...
  <header>
    ...
    <div class="container">
      ...
      <div id="pagename">
        <div class="inside">
          <h2>Buy Now - Instant Activation with Paypal</h2>
          <p class="breadcrumbs">You are here : <a href="index.php">Home</a> / Buy Now</p>
        </div>
      </div>
    </div>
    <!-- container END here -->
  ...
  <div id="content">
	...
	<center><h3>Please enter your desired username and click the Buy Now button.</h3><br/>
	<h4>You will be redirected to Paypal to finalize and send payment.</h4><br/>
	<h4>Freedom Package | $4.00</h4>
	
	<form name="buynow" action="https://www.paypal.com/cgi-bin/webscr" onsubmit="return validateForm()" method="post">
	<input type="hidden" name="cmd" value="_s-xclick">
	<input type="hidden" name="hosted_button_id" value="9EGEMXZHPW2AG">
	<input name="custom" type="text" id="custom" width="150" placeholder="Desired Username"><img id="tick" src="tick.png" width="14" height="14"/>
	<img id="cross" src="cross.png" width="14" height="14"/><br/>
	Only letters please.<br/><br/>
	...
	<input onclick="return fun()" type="image" src="https://www.sandbox.paypal.com/en_US/i/btn/btn_buynow_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
	</form>
	</center>
	-->
	<?php
